...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/y02NWZt.jpg' : process.env.GAN_IMAGE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Blooper' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919744267478@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    YAK: process.env.YAK === undefined ? '919744267578,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUPPORT: "919895828468-1632986420",
    SUPPORT2: "919072790587-1627666570",
