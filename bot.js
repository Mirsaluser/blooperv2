...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold(' Blooper Has Started ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🍃'));
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ BLOOPER ~______~*' +
                                    '\n*🌀 Subcribe this channel other wise chance to get erorr: https://youtube.com/channel/UC56baqlzh4BQET7S1jASiFA*' +
                                    '\n\n*⚠️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
